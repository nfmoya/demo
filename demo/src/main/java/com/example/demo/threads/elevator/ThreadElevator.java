 ...
 */
public class ThreadElevator implements Runnable{
    ...
    public void setOperating(boolean state){
        ...
        if(!state){
            ...
            ThreadElevatorController.updateElevatorLists(this);
        }
     ...
     */
    public void move(){
        synchronized (ThreadElevatorController.getInstance()){ // Synchronized over the ThreadElevatorController singleton.
            ...
            while(iter.hasNext()){
                ...
                while (!floorStops.isEmpty()) {
                    ...
                    System.out.println("ThreadElevator ID " + this.id + " | Current floor - " + getCurrentFloor() + " | next move - " + getElevatorState());
            ...
            try {
                ...
                ThreadElevatorController.getInstance().wait();
            } catch (InterruptedException e) {
                e.printStackTrace();
            }
        }
